...
const GetReservationID = "http://10.1.0.99:3333/reservation?resavtnID=";
const PutReservation ="http://10.1.0.99:3333/reservatn"
const RoomUrl2 = "http://10.1.0.99:3333/getrmstatus";
const RoomUrl3 = "http://10.1.0.99:3333/newRoomStat?wrtRmNum=";
                ...
                return(
                    <>
                        <tr key= {item._id}>
                            ...
                            <td className="table-light table-striped adjust2">{item.memo}</td>
