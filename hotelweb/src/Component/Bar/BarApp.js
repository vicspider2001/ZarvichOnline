...
const restMenugrpUrl = "http://10.1.0.99:3333/drinkCategories";
const menuUrl = "http://10.1.0.99:3333/drinkitems?drinktypes=";
const postRestBill = "http://10.1.0.99:3333/bar";
const getRooms ="http://10.1.0.99:3333/checkin?docket=Yes";
const getGuestID = "http://10.1.0.99:3333/checkin?roomNumID=";
const postDocketToRoom = "http://10.1.0.99:3333/bill";
const getPaymentMethods = "http://10.1.0.99:3333/paymentMethods";
const putToTable = "http://10.1.0.99:3333/barTablePost";
const getTable = "http://10.1.0.99:3333/barTable";
const getTableID = "http://10.1.0.99:3333/barTable?tableID=";
const getStoreData = "http://10.1.0.99:3333/getBarStore";
const postBarSalesQty = "http://10.1.0.99:3333/postBarSalesQty";
const getBarSalesQty = "http://10.1.0.99:3333/getBarSalesQty";
const userName = "http://10.1.0.99:3333/barUserInfo";

const postRestCredit = "http://10.1.0.99:3333/barCredit";
const getRestCredit = "http://10.1.0.99:3333/barCreditSales?BCstaff=";
            ...
            <div className="posterminal">  
                ...
                <Modal open={this.state.edit}>
                    ...
                    <div className = "posPrint">
                        ...
                        <hr/>
                        <p style={{fontSize:'15px', fontFamily: 'Georgia, Times New Roman, Times, serif', fontWeight:'bolder'}}>Total:<NumberFormat value={this.state.cost} thousandSeparator={true} displayType={"text"}/>.00</p>
                        <p style={{fontSize:'15px', fontFamily: 'Georgia, Times New Roman, Times, serif', fontWeight:'bolder'}}>Amount Paid:<NumberFormat value={add} thousandSeparator={true} displayType={"text"}/>.00</p>
                        <p style={{fontSize:'15px', fontFamily: 'Georgia, Times New Roman, Times, serif', fontWeight:'bolder'}}>Bal: <NumberFormat value={this.state.cost-parseFloat(add)} thousandSeparator={true} displayType={"text"}/>.00</p>
                        <p style={{fontSize:'15px', fontFamily: 'Georgia, Times New Roman, Times, serif', fontWeight:'bolder'}}>Payment Method: {this.state.paymentMethod}</p>
                        <hr/>
